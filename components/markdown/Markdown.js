...
import { Row, Col, Button, Dropdown, Form, Menu, Icon, Collapse, Input, message, List, Avatar, Modal } from 'antd';
import {
    getAllArticles,
    createNewArticle,
    getAllCollects,
...
class MDEditor extends Component {
    ...
    handleOk = async (e) => {
        ...
        const { updateArticleById, createNewArticle, updateCollectById, getArticleByCollectId } = this.props;
